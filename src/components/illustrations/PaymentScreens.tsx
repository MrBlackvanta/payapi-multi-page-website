  ...
  return (
    ...
    >
      <defs>
        ...
        <rect id="screens-h" x="0" y="0" width="176" height="191" rx="5" />
        <rect id="screens-n" x="0" y="0" width="204" height="40" rx="5" />
        <rect id="screens-p" x="0" y="0" width="204" height="40" rx="5" />
        <rect id="screens-r" x="0" y="0" width="204" height="40" rx="5" />
        <rect id="screens-t" x="0" y="0" width="204" height="40" rx="5" />
        <rect id="screens-v" x="0" y="0" width="204" height="40" rx="5" />
        <rect id="screens-x" x="0" y="0" width="204" height="40" rx="5" />
        <rect id="screens-z" x="0" y="0" width="204" height="40" rx="5" />
        <rect id="screens-B" x="0" y="0" width="204" height="56" rx="5" />
        <path
      ...
      <g fill="none" fillRule="evenodd">
        <g transform="translate(356 55)">
          <use fill="#000" filter="url(#screens-a)" xlinkHref="#screens-b" />
          <use fill="#213648" xlinkHref="#screens-b" />
        </g>
        <path
        ...
        <g transform="translate(371.074 67.444)">
          <use fill="#36536B" xlinkHref="#screens-f" />
        </g>
        <g>
          <g transform="translate(399 197)">
            <use fill="#000" filter="url(#screens-g)" xlinkHref="#screens-h" />
            <use fill="#FBFCFE" xlinkHref="#screens-h" />
          </g>
          <text
            fontFamily="inherit"
            fontSize="13"
          ...
          >
            ...
            <tspan x="88.749" y="80" fontFamily="inherit" fontWeight="bold">
              $9204
            </tspan>{" "}
            <tspan x="23.736" y="98">
              is completed and{" "}
        ...
        <g>
          <g transform="translate(53 55)">
            <use fill="#000" filter="url(#screens-i)" xlinkHref="#screens-j" />
            <use fill="#213648" xlinkHref="#screens-j" />
          </g>
          <path
            d="M225.18 0H32.356C23.352.549 15.05 4.657 7.447 12.324c4.89-4.268 13.61-9.98 25.14-9.98h192.362c11.53 0 20.25 5.712 25.14 9.98C242.486 4.657 234.183.549 225.18 0z"
            fillOpacity=".65"
          ...
          <g transform="translate(68.074 67.444)">
            <mask id="screens-l" fill="#fff">
              <use xlinkHref="#screens-k" />
            </mask>
            <use fill="#EDF3F8" xlinkHref="#screens-k" />
            <g mask="url(#screens-l)">
              <g transform="translate(14.926 160.556)">
                <use
                  fill="#000"
                  filter="url(#screens-m)"
                  xlinkHref="#screens-n"
                />
                <use fill="#FBFCFE" xlinkHref="#screens-n" />
              </g>
              <g fill="#36536B">
                <text
                  opacity=".7"
              ...
              <g transform="translate(14.926 208.556)">
                <use
                  fill="#000"
                  filter="url(#screens-o)"
                  xlinkHref="#screens-p"
                />
                <use fill="#FBFCFE" xlinkHref="#screens-p" />
              </g>
              <g fill="#36536B">
                <text
                  opacity=".7"
              ...
              <g transform="translate(14.926 256.556)">
                <use
                  fill="#000"
                  filter="url(#screens-q)"
                  xlinkHref="#screens-r"
                />
                <use fill="#FBFCFE" xlinkHref="#screens-r" />
              </g>
              <g fill="#36536B">
                <text
                  opacity=".7"
              ...
              <g transform="translate(14.926 304.556)">
                <use
                  fill="#000"
                  filter="url(#screens-s)"
                  xlinkHref="#screens-t"
                />
                <use fill="#FBFCFE" xlinkHref="#screens-t" />
              </g>
              <g fill="#36536B">
                <text
                  opacity=".7"
              ...
              <g>
                <g transform="translate(14.926 352.556)">
                  <use
                    fill="#000"
                    filter="url(#screens-u)"
                    xlinkHref="#screens-v"
                  />
                  <use fill="#FBFCFE" xlinkHref="#screens-v" />
                </g>
                <g fill="#36536B">
                  <text
                    opacity=".7"
              ...
              <g>
                <g transform="translate(14.926 400.556)">
                  <use
                    fill="#000"
                    filter="url(#screens-w)"
                    xlinkHref="#screens-x"
                  />
                  <use fill="#FBFCFE" xlinkHref="#screens-x" />
                </g>
                <g fill="#36536B">
                  <text
                    opacity=".7"
              ...
              <g>
                <g transform="translate(14.926 448.556)">
                  <use
                    fill="#000"
                    filter="url(#screens-y)"
                    xlinkHref="#screens-z"
                  />
                  <use fill="#FBFCFE" xlinkHref="#screens-z" />
                </g>
                <g fill="#36536B">
                  <text
                    opacity=".7"
            ...
            <path fill="#36536B" mask="url(#screens-l)" d="M0 0h233v114H0z" />
            <g mask="url(#screens-l)">
              <g transform="translate(14.926 80.556)">
                <use
                  fill="#000"
                  filter="url(#screens-A)"
                  xlinkHref="#screens-B"
                />
                <use fill="#FBFCFE" xlinkHref="#screens-B" />
              </g>
              <text
                opacity=".7"
                fontFamily="inherit"

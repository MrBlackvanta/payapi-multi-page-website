...
export default function CodeWindow(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 605 444"
      width="605"
    ...
    >
      <defs>
        ...
        <rect id="code-b" x="0" y="0" width="445" height="284" rx="8" />
      </defs>
      <g fill="none" fillRule="evenodd">
        <g transform="translate(55 55)">
          <use fill="#000" filter="url(#code-a)" xlinkHref="#code-b" />
          <use fill="#1B262F" xlinkHref="#code-b" />
        </g>

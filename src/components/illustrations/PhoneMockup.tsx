...
export default function PhoneMockup(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <defs>
        <linearGradient id="phone-c" x1="50%" x2="50%" y1="0%" y2="100%">
          <stop offset="0%" stopColor="#454545" />
          <stop offset="22.628%" stopColor="#999" />
          <stop offset="100%" stopColor="#FFF" />
        </linearGradient>
        <linearGradient id="phone-d" x1="100%" x2="30.702%" y1="50%" y2="50%">
          <stop offset="0%" stopColor="#FFF" stopOpacity="0" />
          <stop offset="22.218%" stopColor="#BABABA" />
          <stop offset="54.678%" stopColor="#FFF" stopOpacity="0" />
          <stop offset="100%" stopColor="#FFF" stopOpacity="0" />
        </linearGradient>
        <linearGradient id="phone-e" x1="100%" x2="30.591%" y1="50%" y2="50%">
          <stop offset="0%" stopColor="#FFF" stopOpacity="0" />
          <stop offset="22.218%" stopColor="#BABABA" />
          <stop offset="54.678%" stopColor="#FFF" stopOpacity="0" />
          <stop offset="100%" stopColor="#FFF" stopOpacity="0" />
        </linearGradient>
        <linearGradient id="phone-g" x1="50%" x2="50%" y1="0%" y2="99.221%">
        ...
        />
        <rect id="phone-j" width="218" height="87" x="0" y="0" rx="5" />
      </defs>
      <g fill="none" fillRule="evenodd" transform="translate(53 55)">
        <use fill="#000" filter="url(#phone-a)" xlinkHref="#phone-b" />
        <use fill="#213648" xlinkHref="#phone-b" />
        <path
          fill="url(#phone-c)"
          fillOpacity=".65"
        ...
        <g transform="translate(15.074 12.444)">
          <mask id="phone-h" fill="#fff">
            <use xlinkHref="#phone-f" />
          </mask>
          <use fill="#FFF" xlinkHref="#phone-f" />
          <path
            fill="url(#phone-g)"
            mask="url(#phone-h)"
        ...
        <g transform="translate(22 167)">
          <use fill="#000" filter="url(#phone-i)" xlinkHref="#phone-j" />
          <use fill="#FBFCFE" xlinkHref="#phone-j" />
          <g fontSize="10">
            <text
              fill="#BA4270"
              fontFamily="inherit"
          ...
          <text fill="#36536B" fontFamily="inherit" fontSize="10">
            <tspan x="16" y="40">
            ...
            <tspan x="63.62" y="68" fontFamily="inherit" fontWeight="bold">
              {" "}
              US $104.90
            </tspan>{" "}
